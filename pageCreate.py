...
rootDirectory = '/Valculus/Valculus'       # local
# rootDirectory = '/Valculus'       # upload
...
def create_page(mode, sectionNumber, sectionLabel, filePath):
    ...
    if mode.lower() == 'section':
        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}.html", 'w',
                  encoding='utf-8') as file:
        ...
        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}.html", 'r',
                  encoding='utf-8') as file:
            data = file.read()
    ...
    # exercise
        ...
        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}-exercises.html", 'w',
                  encoding='utf-8') as file:
            file.write(doc.render())

        appendContent = generateExerciseContent.generate_exercise_content(sectionLabel, sectionNumber)

        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}-exercises.html", "r",
                  encoding='utf-8') as file:
            data = file.read()
            data = data.replace('<!--APPEND CONTENT HERE-->', appendContent). \
                replace('<!--APPEND HEADER HERE-->', headerContent). \
    ...
    # solution
        ...
        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}-exercises-solutions.html", 'w',
                  encoding='utf-8') as file:
            file.write(doc.render())

        appendContent = generateSolutionsContent.generate_solutions_content(sectionLabel)

        with open(f"Valculus/calculus/{sectionNumber}-{sectionLabelHyphenated}-exercises-solutions.html", "r",
                  encoding='utf-8') as file:
            data = file.read()
            data = data.replace('<!--APPEND CONTENT HERE-->', appendContent). \
                replace('<!--APPEND HEADER HERE-->', headerContent). \
        ...
        with open(f"Valculus/index.html", 'w',
                  encoding='utf-8') as file:
            file.write(doc.render())

        appendContent = generateIndexContent.indexContent()

        with open(f"Valculus/index.html", "r",
                  encoding='utf-8') as file:
            data = file.read()
            data = data.replace('<!--APPEND CONTENT HERE-->', appendContent). \
                replace('<!--APPEND HEADER HERE-->', headerContent). \
    ...
    # all other pages
        ...
        with open(f"Valculus/{filePath}", 'w',
                  encoding='utf-8') as file:
            file.write(doc.render())
        ...
        with open(f"Valculus/{filePath}", 'r',
                  encoding='utf-8') as file:
            data = data.replace('<!--APPEND CONTENT HERE-->', appendContent). \
                replace('<!--APPEND HEADER HERE-->', headerContent). \
                replace('<!--APPEND FOOTER HERE-->', footerContent)
        ...
        # with open(f"Valculus/{filePath}", "w", encoding="utf-8") as file:
        #     file.write(doc.render())
        #
